...
function usp_about_plugin() {
	...
	if (isset($plugin_data['AuthorURI']))  $plugin_data['AuthorURI']  = '<a target="_blank" href="https://monzillamedia.com/">Monzilla Media</a> '. esc_html__('and', 'usp-pro') .' <a target="_blank" href="https://perishablepress.com/">Perishable Press</a>';
	...
	$about_plugin .= '<li><strong>'. esc_html__('Donate Link:', 'usp-pro') .' </strong> <a target="_blank" href="https://m0n.co/donate">https://m0n.co/donate</a></li>';
