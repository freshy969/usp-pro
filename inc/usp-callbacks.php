...
function callback_input_text_label($id) {
	...
	elseif ($id == 'html_content')            $label = esc_html__('HTML tags that should be allowed in submitted post content and/or post excerpt.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-enable-post-formatting/">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_1')             $label = esc_html__('Name for the &ldquo;Your Name&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-name">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_2')             $label = esc_html__('Name for the &ldquo;Post URL&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-url">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_3')             $label = esc_html__('Name for the &ldquo;Post Title&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-title">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_4')             $label = esc_html__('Name for the &ldquo;Post Tags&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-tags">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_5')             $label = esc_html__('Name for the &ldquo;Challenge Question&rdquo; and &ldquo;reCAPTCHA&rdquo; fields.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-captcha">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_6')             $label = esc_html__('Name for the &ldquo;Post Category&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-category">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_7')             $label = esc_html__('Name for the &ldquo;Post Content&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-content">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_8')             $label = esc_html__('Name for the &ldquo;File(s)&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-files">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_9')             $label = esc_html__('Name for the &ldquo;Email Address&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-email">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_10')            $label = esc_html__('Name for the &ldquo;Email Subject&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#usp-subject">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_11')            $label = esc_html__('Name for the &ldquo;Alt Text&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-metadata-for-submitted-files/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_12')            $label = esc_html__('Name for the &ldquo;Caption&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-metadata-for-submitted-files/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_13')            $label = esc_html__('Name for the &ldquo;Description&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-metadata-for-submitted-files/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_14')            $label = esc_html__('Name for the &ldquo;Taxonomy&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#custom-taxonomy">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_15')            $label = esc_html__('Name for the &ldquo;Post Format&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#post-format">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_16')            $label = esc_html__('Name for the &ldquo;Media Title&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-metadata-for-submitted-files/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_17')            $label = esc_html__('Name for the &ldquo;File Name&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-metadata-for-submitted-files/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'usp_error_18')            $label = esc_html__('Name for the &ldquo;Agree to Terms&rdquo; field.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#agree-to-terms">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	...
	elseif ($id == 'redirect_success')        $label = esc_html__('Where should visitors go after successful form submission? Enter any complete URL (e.g.,', 'usp-pro') .' <code>http://example.com</code>'. esc_html__(') or leave blank to redirect to the current page. Note that you can', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-redirects/">'. esc_html__('override this setting on any form', 'usp-pro') .'</a>. '. esc_html__('Important: this option is for advanced users; recommended to leave blank. See', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-error-messages-custom-redirects/">'. esc_html__('this post', 'usp-pro') .'</a> '. esc_html__('for more info.', 'usp-pro');
	elseif ($id == 'redirect_failure')        $label = esc_html__('Where should visitors go after failed form submission? Enter any complete URL (e.g.,', 'usp-pro') .' <code>http://example.com</code>'. esc_html__(') or leave blank to redirect to the current page. Important: this option is for advanced users; recommended to leave blank. See', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-error-messages-custom-redirects/">'. esc_html__('this post', 'usp-pro') .'</a> '. esc_html__('for more info.', 'usp-pro');
	...
	elseif ($id == 'files_allow')             $label = esc_html__('Allowed file types (comma-separated) for any USP Form.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-allowed-file-types/">Learn more&nbsp;&raquo;</a>';
	...
	elseif ($id == 'featured_key')            $label = esc_html__('Image to use as the Featured Image (when &ldquo;Featured Images&rdquo; setting is enabled).', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-featured-image-key/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
...
function callback_textarea_label($id) {
	...
	elseif ($id == 'blacklist_terms')         $label = esc_html__('Words that are not allowed in any submitted post content and/or post excerpt (', 'usp-pro') .' <a target="_blank" href="http://delim.co/">'. esc_html__('put each word on its own line', 'usp-pro') .'</a> )';
	...
	elseif ($id == 'usp_error_15_desc')       $label = esc_html__('Post Format errors &ndash; when using', 'usp-pro') .' <code>[usp_custom_field]</code>. <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#post-format">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
...
function callback_checkbox_label($id) {
	...
	elseif ($id == 'contact_custom')       $label = esc_html__('Append any Custom Field data to messages.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-displaying-custom-fields/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	...
	elseif ($id == 'use_author')           $label = esc_html__('Use the registered username as the Post Author.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-use-registered-author/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'replace_author')       $label = esc_html__('Use submitted name as Post Author, and submitted URL as Author URL.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-replace-author-name-url/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a>';
	...
	elseif ($id == 'user_shortcodes')      $label = esc_html__('Check this box to enable User Shortcodes in submitted post content.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-user-shortcodes/">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
	elseif ($id == 'enable_media')         $label = esc_html__('Enable non-admin users to upload media via the &ldquo;Add Media&rdquo; button.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-enable-non-admin-users-upload-media/">'. esc_html__('Learn more &raquo;', 'usp-pro') .'</a>';
...
function callback_dropdown_label($id) {
	...
	elseif ($id == 'number_approved') $label = esc_html__('Note: this setting', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-post-status/">'. esc_html__('can be overridden per form', 'usp-pro') .'</a>';
