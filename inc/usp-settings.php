...
function section_general_0_desc() {
	echo '<p class="intro">'. esc_html__('Welcome to USP Pro! Before diving in,', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-quick-start/">'. esc_html__('check out the Quick Start guide &raquo;', 'usp-pro') .'</a></p>'; 
}
...
function section_general_2_desc() { 
	echo '<p>'. esc_html__('These settings control how forms behave if returned with an error.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-add-remember-me-checkbox/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>'; 
}
...
function section_general_4_desc() { 
	echo '<p>'. esc_html__('Here you may configure the Google reCAPTCHA and antispam/challenge question.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-add-google-recaptcha/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>'; 
}
...
function section_general_7_desc() { 
	...
	echo esc_html__('in the appropriate field(s) below. See', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-enable-extra-form-security/">'. esc_html__('this post', 'usp-pro') .'</a> '. esc_html__('for more information.', 'usp-pro') .'</p>'; 
}

// STYLE TAB

function section_style_0_desc() { 
	echo '<p class="intro">'. esc_html__('Customize the appearance (CSS) and behavior (JavaScript) of USP Forms.', 'usp-pro'). ' <a target="_blank" href="https://plugin-planet.com/usp-pro-adding-css-javascript/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
}
...
function section_uploads_0_desc() { 
	...
	echo '<a target="_blank" href="https://plugin-planet.com/usp-pro-multiple-file-upload-fields/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
}
...
function section_admin_3_desc() { 
	...
	echo esc_html__('in your alert messages to display dynamic bits of information.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-email-shortcodes/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
...
function section_admin_5_desc() { 
	echo '<p>'. esc_html__('Here you may customize default', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-make-contact-form/">'. esc_html__('contact form', 'usp-pro') .'</a> '. esc_html__('functionality. For ', 'usp-pro');
	echo '<a target="_blank" href="https://plugin-planet.com/usp-pro-submit-content-and-send-email/">'. esc_html__('Contact/Post Combo Forms', 'usp-pro') .'</a>, '. esc_html__('you can use any of the ', 'usp-pro');
	...
	echo '<a target="_blank" href="https://plugin-planet.com/usp-pro-enable-post-formatting/">'. esc_html__('post-formatting', 'usp-pro') .'</a> '. esc_html__('must be enabled to send HTML-formatted email.', 'usp-pro') .'</p>';
...
function section_admin_6_desc() {
	echo '<p>'. esc_html__('Here you may specify custom recipients for any contact form.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-recipients-contact-forms/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
}
...
function section_advanced_3_desc() { 
	...
	echo esc_html__('Note that default fields also may be specified on a per-form basis by', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-set-values-with-hidden-fields/">'. esc_html__('setting values with hidden fields', 'usp-pro') .'</a>.</p>'; 
}
...
function section_advanced_6_desc() {
	echo '<p>'. esc_html__('Here you may customize default names/labels for primary fields. These values may be customized on a per-form basis via the', 'usp-pro') .' <code>label</code> '. esc_html__('attribute.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-change-label-and-placeholder-text/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
}
function section_advanced_7_desc() { 
	echo '<p>'. esc_html__('Here you may customize default names/labels for', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#user-registration-attributes">'. esc_html__('user-registration fields', 'usp-pro') .'</a>. '. esc_html__('These values may be customized on a per-form basis via the', 'usp-pro') .' <code>label</code> '. esc_html__('attribute.', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-make-registration-form/">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
}
function section_advanced_8_desc() { 
	echo '<p>'. esc_html__('Number of Custom Fields to auto-generate for each USP Form.', 'usp-pro') .' <a id="usp-toggle-a1" class="usp-toggle-a1" href="#usp-toggle-a1" title="'. esc_attr__('Show/Hide Description', 'usp-pro') .'">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	...
	echo esc_html__('each with its own option in the following setting, &ldquo;Custom Field Names&rdquo;. Note that unused Custom Fields are fine; the idea is to have them readily available for each form.', 'usp-pro') .'</p>'; 
}
function section_advanced_9_desc() {
	echo '<p>'. esc_html__('Here you may define names for Custom Fields (see previous setting).', 'usp-pro') .' <a id="usp-toggle-a2" class="usp-toggle-a2" href="#usp-toggle-a2" title="'. esc_attr__('Show/Hide Description', 'usp-pro') .'">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	echo '<p class="usp-a2 usp-toggle default-hidden">';
	echo esc_html__('The names defined in this setting are used for Custom Fields displayed in error messages, contact-form messages, and elsewhere. They apply only to Custom Fields that are named numerically. ', 'usp-pro');
	echo esc_html__('For example, the &ldquo;Name for Custom Field #1&rdquo; applies to any custom field that uses', 'usp-pro') .' <code>name#1</code> '. esc_html__('as its name attribute.', 'usp-pro') .'</p>'; 
}
function section_advanced_10_desc() {
	echo '<p>'. esc_html__('Here you may specify a unique prefix to use for Custom Field names.', 'usp-pro') .' <a id="usp-toggle-a3" class="usp-toggle-a3" href="#usp-toggle-a3" title="'. esc_attr__('Show/Hide Description', 'usp-pro') .'">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	...
	echo '<strong>'. esc_html__('Important:', 'usp-pro') .'</strong> '. esc_html__('do not use', 'usp-pro') .' <code>usp-</code> '. esc_html__('or', 'usp-pro') .' <code>usp_</code> '. esc_html__('for the custom prefix (these are reserved for default Custom Fields).', 'usp-pro') .'</p>';
}
function section_advanced_11_desc() { 
	echo '<p>'. esc_html__('Here you may specify any of your own', 'usp-pro') .' <em>'. esc_html__('Custom', 'usp-pro') .'</em> '. esc_html__('Custom Field names (separated by commas).', 'usp-pro') .' <a id="usp-toggle-a4" class="usp-toggle-a4" href="#usp-toggle-a4" title="'. esc_attr__('Show/Hide Description', 'usp-pro') .'">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	...
	echo esc_html__('your Custom Field names must NOT begin with', 'usp-pro') .' <code>usp-</code> '. esc_html__('or', 'usp-pro') .' <code>usp_</code> '. esc_html__('(these are reserved for default Custom Fields).', 'usp-pro') .'</p>';
}
function section_advanced_12_desc() { 
	echo '<p>'. esc_html__('Here you may define names for any', 'usp-pro') .' <em>'. esc_html__('Custom', 'usp-pro') .'</em> '. esc_html__('Custom Fields (see previous setting).', 'usp-pro') .' <a id="usp-toggle-a5" class="usp-toggle-a5" href="#usp-toggle-a5" title="'. esc_attr__('Show/Hide Description', 'usp-pro') .'">'. esc_html__('Learn more&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	echo '<p class="usp-a5 usp-toggle default-hidden">';
	echo esc_html__('The names defined in this setting are used for Custom Custom Fields displayed in error messages, contact-form messages, and elsewhere. ', 'usp-pro');
	echo esc_html__('Note: in order to define any names, you first must specify some Custom Fields in the previous setting; then after clicking &ldquo;Save Changes&rdquo;, corresponding name fields automatically will be generated below.', 'usp-pro') .'</p>';
}
...
function section_license_desc() {
	...
	echo '<a target="_blank" href="https://plugin-planet.com/get-license-key/">'. esc_html__('Get your License Key&nbsp;&raquo;', 'usp-pro') .'</a></p>';
	...
	echo '<li><a target="_blank" href="https://plugin-planet.com/get-license-key/">'. esc_html__('Get Your License Key', 'usp-pro') .'</a></li>';
	echo '<li><a target="_blank" href="https://plugin-planet.com/manage-license/">'. esc_html__('Manage Licensed Domains', 'usp-pro') .'</a></li>';
	echo '<li><a target="_blank" href="https://plugin-planet.com/download-purchased-plugin/">'. esc_html__('Download Current Version', 'usp-pro') .'</a></li>';
	echo '<li><a target="_blank" href="https://plugin-planet.com/download-purchase-receipt/">'. esc_html__('Download Purchase Receipt', 'usp-pro') .'</a></li>';
	echo '<li><a target="_blank" href="https://plugin-planet.com/troubleshooting-license-activation/">'. esc_html__('Troubleshooting License Activation', 'usp-pro') .'</a></li>';
	echo '</ul>';
}
