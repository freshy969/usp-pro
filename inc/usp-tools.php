...
function usp_tools_shortcodes() {
	...
	$tools_shortcodes .= esc_html__('To get started,', 'usp-pro') . ' <a href="http://codex.wordpress.org/Shortcode_API" target="_blank">' . esc_html__('learn how to use Shortcodes', 'usp-pro') . '</a> ';
	$tools_shortcodes .= esc_html__('and then include USP Shortcodes as needed in your Posts and Pages.', 'usp-pro') .'</p>';
	$tools_shortcodes .= '<p><a href="https://plugin-planet.com/usp-pro-shortcodes/" target="_blank">'. esc_html__('Check out the complete list of USP Shortcodes &raquo;', 'usp-pro') .'</a></p>';
	$tools_shortcodes .= '<p>' . esc_html__('In addition to those provided by USP Pro, there are numerous', 'usp-pro') . ' <a href="http://codex.wordpress.org/Shortcode" target="_blank">' . esc_html__('default WP shortcodes', 'usp-pro') . '</a>, ';
...
function usp_tools_tags() {
	...
	$tools_tags .= esc_html__('To get started,', 'usp-pro') . ' <a href="http://codex.wordpress.org/Template_Tags" target="_blank">' . esc_html__('learn how to use Template Tags', 'usp-pro') . '</a> ';
	$tools_tags .= esc_html__('and then include USP Template Tags as needed in your theme template.', 'usp-pro') . '</p>';
	$tools_tags .= '<p><a href="https://plugin-planet.com/usp-pro-template-tags/" target="_blank">'. esc_html__('Check out the complete list of USP Template Tags &raquo;', 'usp-pro') .'</a></p>';
...
function usp_tools_resources() {
	...
	$tools_resources .= '<ul>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/docs/usp/">'.                         esc_html__('USP Pro Docs', 'usp-pro')                                 .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/tuts/">'.                             esc_html__('USP Pro Tutorials', 'usp-pro')                            .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/forum/usp/">'.                        esc_html__('USP Pro Forum', 'usp-pro')                                .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/news/">'.                             esc_html__('USP Pro News', 'usp-pro')                                 .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro/#contact">'.                  esc_html__('Bug reports, help requests, and feedback', 'usp-pro')     .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/wp/wp-login.php">'.                   esc_html__('Log in to your account for current downloads', 'usp-pro') .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://digwp.com/2011/09/where-to-get-help-with-wordpress/">'. esc_html__('Where to Get Help with WordPress', 'usp-pro')             .'</a></li>';
	$tools_resources .= '</ul>';
	
	$tools_resources .= '<h3>'. esc_html__('Key resources at the WordPress Codex', 'usp-pro') .'</h3>';
	$tools_resources .= '<ul>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Templates">'.         esc_html__('WP Theme Templates', 'usp-pro')       .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/WordPress_Widgets">'. esc_html__('WP Widgets', 'usp-pro')               .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Shortcode_API">'.     esc_html__('WP Shortcodes', 'usp-pro')            .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Template_Tags">'.     esc_html__('WP Template Tags', 'usp-pro')         .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Quicktags_API">'.     esc_html__('WP Quicktags', 'usp-pro')             .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Post_Types">'.        esc_html__('WP Custom Post Types', 'usp-pro')     .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/The_Loop">'.          esc_html__('The WordPress Loop', 'usp-pro')       .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://codex.wordpress.org/Troubleshooting">'.   esc_html__('WP Troubleshooting Guide', 'usp-pro') .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="http://www.wordpress.org/support/">'.            esc_html__('WP Help Forum', 'usp-pro')            .'</a></li>';
	$tools_resources .= '</ul>';
	
	$tools_resources .= '<h3>'. esc_html__('More WordPress plugins by Jeff Starr', 'usp-pro') .'</h3>';
	$tools_resources .= '<ul>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/bbq-pro/">'. esc_html__('BBQ Pro - Advanced WordPress Firewall', 'usp-pro') .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://plugin-planet.com/ses-pro/">'. esc_html__('SES Pro - Simple Ajax Signup Forms', 'usp-pro') .'</a></li>';
	$tools_resources .= '</ul>';
	
	$tools_resources .= '<h3>'. esc_html__('WordPress books and resources by Jeff Starr', 'usp-pro') .'</h3>';
	$tools_resources .= '<ul>';
	$tools_resources .= '<li><a target="_blank" href="https://digwp.com/">'.                        esc_html__('Digging Into WordPress, by Chris Coyier and Jeff Starr', 'usp-pro')                      .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://wp-tao.com/">'.                       esc_html__('The Tao of WordPress &ndash; Complete guide for users, admins, and everyone', 'usp-pro') .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://wp-tao.com/wordpress-themes-book/">'. esc_html__('WordPress Themes In Depth &ndash; Complete guide to building awesome themes', 'usp-pro') .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://htaccessbook.com/">'.                 esc_html__('.htaccess made easy &ndash; Configure, optimize, and secure your site', 'usp-pro')       .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://perishablepress.com/">'.              esc_html__('Perishable Press &ndash; WordPress, Web Design, Code &amp; Tutorials', 'usp-pro')        .'</a></li>';
	$tools_resources .= '<li><a target="_blank" href="https://wp-mix.com/">'.                       esc_html__('WP-Mix &ndash; Useful code snippets for WordPress and more', 'usp-pro')                  .'</a></li>';
	$tools_resources .= '</ul>';
...
function usp_tools_tips() {
	...
	$tools_tips .= '<dd>' . esc_html__('As explained in the ', 'usp-pro') . '<a target="_blank" href="http://codex.wordpress.org/Taxonomies#404_Error">'. esc_html__('WP Codex', 'usp-pro') .'</a>' . esc_html__(', an extra step is required to get WordPress to recognize theme templates for custom post types ', 'usp-pro');
	...
	$tools_tips .= esc_html__('(e.g., at', 'usp-pro') .' <code>/usp_post/example/</code>'. esc_html__('), try the well-known fix, which is to simply', 'usp-pro') . ' <a target="_blank" href="' . get_admin_url() . 'options-permalink.php">' . esc_html__('visit the WP Permalinks Settings', 'usp-pro') . '</a>. ';
	...
	$tools_tips .= '<ul>';
	$tools_tips .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro-add-custom-textarea/">'. esc_html__('Textarea', 'usp-pro') .'</a> &ndash; <code>field#textarea</code></li>';
	$tools_tips .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro-custom-fields/">'. esc_html__('Text Input', 'usp-pro') .'</a> &ndash; <code>type#text|placeholder#Orange|label#Orange</code></li>';
	$tools_tips .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro-custom-radio-fields/">'. esc_html__('Radio Select', 'usp-pro') .'</a> &ndash; <code>type#radio|name#1|for#1|value#Oranges</code></li>';
	$tools_tips .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro-custom-checkbox-fields/">'. esc_html__('Checkbox', 'usp-pro') .'</a> &ndash; <code>type#checkbox|value#Oranges</code></li>';
	$tools_tips .= '<li><a target="_blank" href="https://plugin-planet.com/usp-pro-custom-select-fields/">'. esc_html__('Select/Option', 'usp-pro') .'</a> &ndash; <code>field#select|options#null:Option 1:Option 2:Option 3|option_default#Please Select..|option_select#null|label#Options</code></li>';
	$tools_tips .= '</ul>';
	
	$tools_tips .= '<p>'. esc_html__('For more fields and other options, check out the', 'usp-pro') .' <a target="_blank" href="https://plugin-planet.com/usp-pro-shortcodes/#custom-fields">'. esc_html__('Custom Field Reference', 'usp-pro') .'</a> '. esc_html__('and', 'usp-pro');
	$tools_tips .= ' <a target="_blank" href="https://plugin-planet.com/usp-pro-custom-field-recipes/" title="'. esc_html__('USP Pro - Custom Field Recipes', 'usp-pro') .'">'. esc_html__('Custom Field Recipes', 'usp-pro') .'&nbsp;&raquo;</a></p></dd>';
	$tools_tips .= '</dl>';
