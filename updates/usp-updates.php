...
function usp_license_page() {
	...
	<div class="wrap">
		...
		<div class="usp-license-steps usp-toggle default-hidden">
			...
			<ol>
				<li><a target="_blank" href="https://plugin-planet.com/get-license-key/"><?php esc_html_e('Get your License Key', 'usp-pro'); ?></a> </li>
			...
			<p>
				...
				<a target="_blank" href="https://plugin-planet.com/install-plugin/"><?php esc_html_e('check out this guide', 'usp-pro'); ?></a> <?php esc_html_e('and/or', 'usp-pro'); ?> 
