...
define('USP_PRO_TESTED',   '4.8');
define('USP_PRO_VERSION',  '2.7.1');
...
if (!class_exists('USP_Pro')) {
	class USP_Pro {
		...
		function usp_i18n_init() {
			load_plugin_textdomain('usp-pro', false, dirname(plugin_basename(__FILE__)) .'/languages/');
		}
		...
		function add_post_filter_button() {
			...
			if (($typenow === 'post' || $typenow === 'page' || $typenow === 'usp_post') || (isset($usp_advanced['post_type']) && $usp_advanced['post_type'] === $typenow)) {
				echo '<a id="usp-admin-filter" class="button" href="'. admin_url('edit.php?user_submitted=1') .'">'. esc_html__('USP', 'usp-pro') .'</a>';
			}
		}
		...
		function add_plugin_links($links, $file) {
			if ($file == plugin_basename(__FILE__)) {
				$links[]  = '<a target="_blank" href="https://plugin-planet.com/usp-pro-quick-start/" title="'. esc_attr__('USP Pro Quick Start Guide', 'usp-pro') .'">'. esc_html__('Getting started', 'usp-pro') .'</a>';
			}
			return $links;
		}
